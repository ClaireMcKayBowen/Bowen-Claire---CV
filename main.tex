...
\begin{itemize}
    ...
    \item Leading a data privacy project on generating synthetic data on employer and employee industry data 
...
\vspace{6pt}
\begin{etaremune}[topsep=0pt, itemsep=6pt, partopsep=0pt, parsep=0pt]
  \item June 2020. \textit{Telling a Visual Story in Big Data: Case Studies on Interactive Visualizations for Supercomputer Data}. Symposium on Data Science and Statistics at Pittsburgh, PA. \textbf{Will be presenting.}
...
\section{Grants \& Fellowships}
    ...
    \vspace{2pt}
    \cventry{}{National Institute of Standards and Technology (NIST) | \$200,000}{NIST: Differential Privacy for Public Safety Communications Research}{\textnormal{\textit{Oct. 2019 - June 2020}}}{}{
